    ...
    <>
      ...
      <div className="flex flex-col gap-2 mt-auto pt-2">
        ...
        <div className="flex flex-col items-center gap-1.5 pb-2">
          ...
          {/* Language switcher */}
          <div className="relative group">
            <div className="w-12 h-9 p-0.5 rounded-xl bg-card border border-border/70 flex items-center gap-0.5">
              <button
                type="button"
                onClick={() => setLocale('fr')}
                className={`flex-1 h-full rounded-lg text-sm transition-all duration-200 ${
                  locale === 'fr'
